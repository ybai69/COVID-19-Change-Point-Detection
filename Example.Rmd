...
After loading the datasets above, we can now clean the data and construct the variables/attributes. Here, we choose the Florida state as an example. One can change the state name and corresponding lockdown date and reopening date to test other states.
