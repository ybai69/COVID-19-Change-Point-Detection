...
filename <- paste0("I_rate_", state.lowernames[1], "_all.pdf")
...
filename <- paste0("R_rate_", state.lowernames[1], "_all.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0("Infected_", state.lowernames[1], ".pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0("Recovered_", state.lowernames[1] ,".pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0("change_", state.lowernames[1], ".pdf")
pdf(filename, width = 11, height = 8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0("Infected_", state.lowernames[1], "_2.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0("Recovered_", state.lowernames[1] ,"_2.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
if(state.name %in% c("Florida", "Texas")){
  for(i in 1:length(beta_t_est)){
    if(date.region[index.date[i]] <= Date.2 &  date.region[index.date[i+1]] > Date.2){
      print(i)
      beta_t_est.reopen <- beta_t_est[i]
      gamma_t_est.reopen <- gamma_t_est[i]
    }
  }
  
  
  I.start <- I[date.region == Date.2]
  ...
  print(I.true[1+7]); print(I.true[1+7*2]); print(I.true[1+7*3])
  print(I.predict[1+7]); print(I.predict[1+7*2]); print(I.predict[1+7*3])
...
filename <- paste0("Infected_", state.lowernames[1] ,"_3.1.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
# Open a pdf file
filename <- paste0("Recovered_", state.lowernames[1] ,"_3.1.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0("Infected_", state.lowernames[1] ,"_3.2.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
# Open a pdf file
filename <- paste0("Recovered_", state.lowernames[1], "_3.2.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0("Infected_", state.lowernames[1] ,"_3.3.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
# Open a pdf file
filename <- paste0("Recovered_", state.lowernames[1], "_3.3.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0("Infected_", state.lowernames[1] ,"_4.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
# Open a pdf file
filename <- paste0("Recovered_", state.lowernames[1], "_4.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0("Infected_", state.lowernames[1] ,"_3.4.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
# Open a pdf file
filename <- paste0("Recovered_", state.lowernames[1], "_3.4.pdf")
pdf(filename, width=11, height=8.5)
par(mar = c(4., 4.5, 1.5, 1))
...
filename <- paste0(state.lowernames[1], "_domain.RData")
save.image(filename)
...
for(i in 1:length(statesnames)){
  ...
  load(filename)
  MPE_res_I <- cbind(MPE_res_I,  round(c(MRPE_1_I, MRPE_2_I, 
                                         MRPE_3.1_I, MRPE_3.2_I, 
                                         MRPE_3.3_I, MRPE_3.4_I, MRPE_4_I),4))
  MPE_res_R <- cbind(MPE_res_R,  round(c(MRPE_1_R, MRPE_2_R, MRPE_3.1_R, MRPE_3.2_R, 
